  ...
  <div id="about" class="flex justify-center items-center pb-20 pt-36">
    <div class="text-white w-[350px] md:w-[730px] mx-auto">
      ...
      <p class="text-sm font-medium text-justify mt-5">
        ...
        specialization in programming. I have two years of coding experience and
        I am a self-taught programmer. During my studies, I worked as a capstone
        programmer within our group, and I also gained valuable experience as a
        Laravel API developer during my internship. I am currently learning
        Vue.js and Laravel to become a full-stack developer and improve my web
        development skills by creating projects using these frameworks. My goal
        is to become a web developer and apply my programming knowledge to
        enhance my skills and contribute to a company's success.
      </p>

      <div class="flex flex-col md:flex-row mt-8 md:mt-20 gap-10">
        <div class="w-full md:w-1/2">
          <h1 class="text-lg font-medium tracking-tighter uppercase">
            Work Experience
          </h1>
        ...
        <div class="w-full md:w-1/2 -mt-1">
          ...
          <h1 class="text-xs font-medium uppercase">2019 - 2023</h1>
          <ul
